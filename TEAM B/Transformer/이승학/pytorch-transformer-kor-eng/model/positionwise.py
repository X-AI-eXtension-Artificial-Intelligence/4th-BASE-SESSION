...
class PositionWiseFeedForward(nn.Module):
    def __init__(self, params):
        ...
        self.conv1 = nn.Conv1d(params.hidden_dim, params.feed_forward_dim, kernel_size=1)    # 2층의 1d conv로 이루어 져있음(fc layer)
        self.conv2 = nn.Conv1d(params.feed_forward_dim, params.hidden_dim, kernel_size=1)
        init_weight(self.conv1)                                                              # model/ops.py의 init_weight
