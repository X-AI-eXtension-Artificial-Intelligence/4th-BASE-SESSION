...
def predict(config):
    ...
    kor_idx = int(torch.where(target[0] == kor_idx)[0][0])
    target = target[0][:kor_idx].unsqueeze(0)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Eng Translation prediction')
    parser.add_argument('--input', type=str, default='what are you doing')
