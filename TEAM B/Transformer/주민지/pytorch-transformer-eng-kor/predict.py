...
def predict(config):
    ...
    eos_idx = kor.vocab.stoi['<eos>'] ## eng -> kor
    ...
    indexed = [eng.vocab.stoi[token] for token in tokenized] ## kor -> eng
    ...
    next_symbol = kor.vocab.stoi['<sos>'] ## eng -> kor
    ...
    translated_token = [kor.vocab.itos[token] for token in target] ## eng->kor
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='I am going to school')
