...
class Encoder(nn.Module):
    def __init__(self, params):
        ...
        nn.init.normal_(self.token_embedding.weight, mean=0, std=params.hidden_dim**-0.5) #weight 초기화
    ...
    def forward(self, source):
        ...
        source_pos = create_position_vector(source)   # [batch size, source length] #포지셔널 임베딩
