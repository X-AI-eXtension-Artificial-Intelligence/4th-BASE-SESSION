...
def build_tokenizer():
    ...
    #eng_lines = [row.english
    #            for _, row in df.iterrows() if type(row.english) == str]

    word_extractor = WordExtractor(min_frequency=5)
    word_extractor.train(kor_lines)
    #word_extractor.train(eng_lines)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--kor_vocab', type=int, default=5500) #55000
    parser.add_argument('--eng_vocab', type=int, default=3000) #30000
