...
class Encoder(nn.Module):
    def __init__(self, params):
        ...
        # token_embedding : 고정 크기 벡터로 변경
        # .Embedding(input_dim, hidden_dim, padding_idx)
        # input_dim : 임베딩 할 단어 개수 (단어 집합의 크기)
        # hidden_dim : 임베딩 할 벡터 차원 (사용자가 정해주는 하이퍼파라미터)
        # padding_idx : 패딩 위한 토큰 인덱스 (선택적 사용)
